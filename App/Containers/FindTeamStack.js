        ...
        return (
            ...
            <View>
                <View style={stylesCustom.textNested}>
                    ...
                    <Text style={{color:'#fff', fontSize: 16, fontWeight: 'bold' }}>DOTA2 Find a Team</Text>
                </View>
                <View style={stylesCustom.textNested}>
                    <Image style={{marginHorizontal: 10, height: 40 ,width: 60, resizeMode: 'contain'}} source={require('../Images/mlbb.png')} />
                    <Text style={{color:'#fff', fontSize: 16, fontWeight: 'bold' }}>Mobile Legends Find a Team</Text>
                </View>
            </View>
            </ScrollView>
